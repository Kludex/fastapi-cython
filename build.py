# Reference: https://github.com/aotuai/example-cython-poetry-pypi
...
from Cython.Distutils.build_ext import new_build_ext as cython_build_ext  # isort: skip
from Cython.Compiler import Options  # isort: skip

Options.embed = "__main__"
